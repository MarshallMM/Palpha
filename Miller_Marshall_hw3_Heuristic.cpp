...
int main(){
  ...
  width=10; //width of the gridworld
  epsilon=0.2; //exploration chance 0-1
  alpha=0.1;  //memory retaining rate 0-1
  gamma= 0.9;
  maxReward=100; //maximum reward when goal is found
  ruleOfThumbToggle=1; //set to 1 if rule of thumb is to be followed
...
wallAState=0;
  ...
  cout<< "steps it took to get to the goal (first 50 episodes):"<< endl;
